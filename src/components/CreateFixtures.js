...
export const CreateFixtures = (props) => {
        ...
        for (let i = 0; i < input; i++) {
            items.push( <
                div className = 'createFixtures-leaderboard__name createFixtures-button__link'
        ...
        return ( <
            ...
            label style = {
                { textAlign: "center" }
            } > Enter the number of fixtures you want to create < /label> <
            input value = { input }
            onChange = {
                (e) => {
                    let btn = document.getElementById("add_fixture_db");
            ...
            >
            <
            button className = 'createFixtures-btn'
            id = 'add_fixture_box'
            onClick = {
                () => { setFlag(true); }
            } >
